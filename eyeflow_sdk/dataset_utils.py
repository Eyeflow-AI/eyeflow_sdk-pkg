...
class Dataset():
    ...
    def get_train_subsets(self):
        ...
        train_dataset.db_config = self.db_config
        train_dataset._cloud_parms = self._cloud_parms
        train_dataset.parms = copy.deepcopy(self.parms)

        val_dataset = Dataset(self.id)
        val_dataset.db_config = self.db_config
        val_dataset._cloud_parms = self._cloud_parms
        val_dataset.parms = copy.deepcopy(self.parms)

        test_dataset = Dataset(self.id)
        test_dataset.db_config = self.db_config
        test_dataset._cloud_parms = self._cloud_parms
